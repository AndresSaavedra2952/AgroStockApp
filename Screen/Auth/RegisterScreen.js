...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    if (formData.rol === 'productor' && step === 1) {
      setStep(2);
      return;
    }
              ...
              <View style={styles.section}>
                ...
                <View style={styles.accountTypeContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => setFormData({ ...formData, rol: 'consumidor' })}
                  >
                    <Text style={[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setFormData({ ...formData, rol: 'productor' })}
                  >
                    <Text style={[
                      styles.accountTypeText,
                ...
                <View style={[styles.formRow, !isTablet && styles.formRowMobile]}>
                  ...
                  <View style={[styles.formColumn, !isTablet && styles.formColumnFull]}>
                    <View style={styles.inputContainer}>
                      ...
                      <Text style={styles.helperText}>Valor por defecto: Agricultor (según BD)</Text>
                    </View>
